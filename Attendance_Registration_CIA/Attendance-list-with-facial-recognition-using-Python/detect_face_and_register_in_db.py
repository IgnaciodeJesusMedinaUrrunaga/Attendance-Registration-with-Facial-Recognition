...
destiny_path = r"C:\Users\Ignacio\Desktop\Facial-Recognition-Attendance\AttendanceCIA\Images"

# Iterates through images in the specified folder and generates encodings
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            if matches[best_match_index]:
                ...
                if not result:
                    # If not registered, adds a new record in the database
